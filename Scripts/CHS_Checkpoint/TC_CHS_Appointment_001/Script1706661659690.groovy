...
WebUI.click(findTestObject('Object Repository/CHS_Appointment_OR/Page_CURA Healthcare Service/a_Make Appointment'))

WebUI.setText(findTestObject('Object Repository/CHS_Appointment_OR/Page_CURA Healthcare Service/input_username'), 'John Doe')

WebUI.setEncryptedText(findTestObject('Object Repository/CHS_Appointment_OR/Page_CURA Healthcare Service/input_password'), 
...
WebUI.verifyCheckpoint(findCheckpoint('Checkpoints/CHS_Checkpoint Facility Internal/CHS_Checkpoint_Facilty_Internal'), false)
...
WebUI.click(findTestObject('Object Repository/CHS_Appointment_OR/Page_CURA Healthcare Service/h2_Appointment Confirmation'))
